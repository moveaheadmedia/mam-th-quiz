...
(function () {
  ...
  var QUESTIONS = [
    {
      ...
      options: [
        ...
        },
        {
          ...
          weights: { seo: 4, "google-ads": 2, social: 2, content: 2 },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          weights: { seo: 4, "web-dev": 24, uxui: 18, cro: 8 },
        },
        {
          id: "unsure",
          ...
          weights: { consult: 30, seo: 3, "google-ads": 3, social: 3 },
        },
      ],
    },
  ];
  ...
  var INTERACTION_RULES = [
    {
      id: "focused-lead-generation",
      when: { budget: "under50", challenge: "leads" },
      weights: { social: 4 },
      label: "A focused lead-generation budget",
    },
    {
      id: "local-lead-generation",
      when: { type: "local", challenge: "leads" },
      weights: { "local-seo": 4, "google-ads": 2 },
      label: "Local lead generation",
    },
    {
      id: "local-search-ranking",
      when: { type: "local", challenge: "ranking" },
      weights: { "local-seo": 11 },
